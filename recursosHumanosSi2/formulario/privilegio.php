...
<title>Privilegio | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('privilegioIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
	...
	$("#btn-view").click(function(){
		...
		{
			$("body").load('privilegio.php');
			$("body").fadeIn('slow');
			window.location.href="privilegio.php";
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Privilegio</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Privilegio</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Privilegio</button>
        <hr />
...
<script type="text/javascript" src="../crud/crudPrivilegio.js"></script>
