...
<title>Lugar de Trabajo | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('lugartrabajoIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
	...
	$("#btn-view").click(function(){
		...
		{
			$("body").load('lugartrabajo.php');
			$("body").fadeIn('slow');
			window.location.href="lugartrabajo.php";
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Lugar de Trabajo</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Lugar de trabajo</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Lugar de Trabajo</button>
        <hr />
		...
		<th class="col-lg-1">Id Convocatoria</th>  
        ...
        <?PHP
               include_once('../entidad/conexion.php');
				...
				$db->conectar();
                $query = "CALL mostrar_lugarTrabajo()";
                $resultadoEmpresa = $db->consulta($query);

		 while ($fila=$db->fetch_array($resultadoEmpresa)){
			?>
			<tr>
			<td><?php echo $fila['idLugarTrabajo']; ?></td>
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idLugarTrabajo']; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
                    ...
                    <a id="<?php/* echo $row['ID'];*/ ?>" class="#" href="#" title="Imprimir"><span class="glyphicon glyphicon-print"></span>
                    </a>
            	</td>
...
<script type="text/javascript" src="../crud/crudLugarTrabajo.js"></script>
