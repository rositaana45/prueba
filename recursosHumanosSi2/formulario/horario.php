...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('horarioIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Horario</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Horario</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Horario</button>
        <hr />
		...
		<th class="col-lg-1">HoraEntrada</th>  
		<th class="col-lg-1">HoraSalida</th> 
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idHorario'];?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
			...
			<td><?php echo $fila['horaEntrada']; ?></td>		
...
<script type="text/javascript" src="../crud/crudHorario.js"></script>
