...
<title>Modificacion | RHSystem</title>
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Modificacion</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Modificacion</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Modificacion</button>
        <hr />
        ...
        <th class="col-lg-1">Contrato Modificado</th>
        </tr>
        </thead>
        <tbody>
        <?PHP
               include_once('../entidad/conexion.php');
				...
				$db->conectar();
                $query = "CALL mostrarContrato_modificado()";
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
        	...
        	<td><?php echo $fila['idContraModifi']; ?></td>	
			</tr>
			<?php
		}   $db->desconectar();
		?>
