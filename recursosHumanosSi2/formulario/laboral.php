...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('laboralIngresar.php?id='+<?php echo $id;?>);
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
	...
	$("#btn-view").click(function(){
		...
		{
			$("body").load('laboral.php');
			$("body").fadeIn('slow');
			window.location.href="laboral.php?idCu="+<?php echo $id;?>;
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Laboral</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Laboral</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Laboral</button>
        ...
        <th class="col-lg-10">lugarTrajao</th>  
		<th class="col-lg-10">tiempo</th> 
		<th class="col-lg-1"> cargo</th>
        <th class="col-lg-1">motivoExtincionContrato</th>
      ...
      <?PHP
               include_once('../entidad/conexion.php');
				...
				$db->conectar();
                $query = "CALL mostrar_laboral('$id')";
                $resultadoEmpresa = $db->consulta($query);

		 while ($fila=$db->fetch_array($resultadoEmpresa)){
			?>
			<tr>
			<td><?php echo $fila['idLaboral']; ?></td>
			...
			<td><?php echo $fila['lugarTrabajo']; ?></td>			
				<td><?php echo $fila['tiempoTrabajo']; ?></td>	
					<td><?php echo $fila['cargo']; ?></td>	
					<td><?php echo $fila['motivoExtincionContrato']; ?></td>	
			</tr>
			<?php
		}
		?>
...
<script type="text/javascript" src="../crud/crudLaboral.js"></script>
