...
<title>Departamento | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('departamentoIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Departamento</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Departamento</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Departamento</button>
        <hr />
        ...
        <?PHP
               include_once('../entidad/conexion.php');
				...
				$db->conectar();
                $query = "CALL mostrar_departamento()";
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idDepartamento'];?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
                    <a style="text-decoration:none;" id="<?php echo $fila['idDepartamento']; ?>" class="delete-link" href="#" title="Eliminar"><span class="glyphicon glyphicon-trash">&nbsp;</span>
                    </a>            
...
<script type="text/javascript" src="../crud/crudDepartamento.js"></script>
