...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('grupoIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Grupo</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Grupo</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Grupo</button>
        <hr />
		...
		<th class="col-lg-4">Categoria</th>  
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idGrupo']; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
...
<script type="text/javascript" src="../crud/crudGrupo.js"></script>
