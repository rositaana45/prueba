...
$insert =  strtoupper('Vizualiso datos de la tabla Vacante');
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('vacanteIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body>
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/vacaciones.png" alt="">&nbsp;&nbsp;	Vacante</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Vacante</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Vacante</button>
        <hr />
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultado)){
			...
			<tr>
               <?php
                 $id1 = $fila['idConvocatoria'];
                $id2 = $id1.".".$fila['idCargo'];
                 ?>
                
                <td class="text-center">
                     <a style="text-decoration:none;" id="<?php echo $id2; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                   </a>
			       <a style="text-decoration:none;" id="" class="delete-link" href="#" title="Eliminar"><span class="glyphicon glyphicon-trash">&nbsp;</span>
                   </a>                         
...
<script type="text/javascript" src="../crud/crudVacante.js"></script>
