...
<title>Validacion | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('validacionInsertar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body>
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/vacaciones.png" alt="">&nbsp;&nbsp;Validacion</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Validar</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Validaciones</button>
        <hr />
...
<script type="text/javascript" src="../crud/crudValidacion.js"></script>
