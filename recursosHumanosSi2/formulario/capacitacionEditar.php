...
if($_REQUEST['edit_id'])
{
                ...
                $db = new Conexion;
				$db->conectar();
                $query = "CALL mostrarCapacitacionId('$id')";
...
#dis{
	...
	<form method='post' id='emp-UpdateForm' action="#">
     ...
     <input type='hidden' name='id' class='form-control' value='<?php echo $row['idCapacidadDesarrollo']; ?>' required>
        <table class='table table-bordered'>
		     <tr>
            <td>instructor</td>
            <td><input type='text' name='instructor' class='form-control' value='<?php echo $row['instructor']; ?>' required></td>
            </tr>
