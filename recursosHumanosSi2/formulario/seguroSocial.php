...
<title>Seguro Social | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('seguroSocialIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
	...
	$("#btn-view").click(function(){
		...
		{
			$("body").load('seguroSocial.php');
			$("body").fadeIn('slow');
			window.location.href="seguroSocial.php";
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Seguro Social</h3><hr/>
        <?php

if($insertar==1){
    echo '
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Seguro Social</button>

        ';}?>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Seguro Social</button>
        <hr />
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                  ...
                  <!--  <a style="text-decoration:none;" id="<?php echo $fila['idSeguroSoial']; ?>" class="delete-link" href="#" title="Eliminar"><span class="glyphicon glyphicon-trash">&nbsp;</span>
                    </a> -->            
                    <a id="<?php/* echo $row['ID'];*/ ?>" class="#" href="#" title="Imprimir"><span class="glyphicon glyphicon-eye-open"></span>
                    </a>
            	</td>
			<td><?php echo $fila['nombreSeguro']; ?></td>	
...
<script type="text/javascript" src="../crud/crudSeguroSocial.js"></script>
