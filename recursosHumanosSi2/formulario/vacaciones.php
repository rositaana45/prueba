...
<title>Vacaciones| RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){    
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('vacacionesIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Vacaciones</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Vacacion</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Vacacion</button>
        <hr />
		...
		<th class="col-lg-1">FechaFinal</th>
        ...
        <?PHP
               include_once('../entidad/conexion.php');
                ...
                $db = new Conexion;
				$db->conectar();
                $query = "CALL mostrarVacaciones()";
                $resultadoEmpresa = $db->consulta($query);

		 while ($fila=$db->fetch_array($resultadoEmpresa)){
			?>
			<tr>
			<td><?php echo $fila['idVacacion']; ?></td>
            <td class="text-center">
                   <!-- <a style="text-decoration:none;" id="<?php echo $fila['idVacacion']; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
                    <a style="text-decoration:none;" id="<?php echo $fila['idVacacion']; ?>" class="delete-link" href="#" title="Eliminar"><span class="glyphicon glyphicon-trash">&nbsp;</span>
                    </a> -->   
...
<script type="text/javascript" src="../crud/crudVacaciones.js"></script>
