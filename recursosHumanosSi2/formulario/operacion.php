...
<title>Operacion | RHSystem</title>
...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('operacionIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
	...
	$("#btn-view").click(function(){
		...
		{
			$("body").load('operacion.php');
			$("body").fadeIn('slow');
			window.location.href="operacion.php";
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Operacion</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Operacion</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Operaciones</button>
        <hr />
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idOperacion']; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
...
<script type="text/javascript" src="../crud/crudOperacion.js"></script>
