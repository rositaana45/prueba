...
$(document).ready(function(){
	...
	$("#btn-add").click(function(){
		$(".content-loader").fadeOut('slow', function()
		{
			...
			$(".content-loader").load('cargoIngresar.php');
			$("#btn-add").hide();
			$("#btn-view").show();
		});
	});
...
<body bgcolor="RED">
	...
	<div class="container">
        ...
        <h3><img class="img-circle" src="../img/profesion.png" alt="">&nbsp;&nbsp;	Cargo</h3><hr/>
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Añadir Cargo</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Ver Cargo</button>
        <hr />
        ...
        <?PHP
		 ...
		 while ($fila=$db->fetch_array($resultadoEmpresa)){
            ...
            <td class="text-center">
                    <a style="text-decoration:none;" id="<?php echo $fila['idCargo']; ?>" class="edit-link" href="#" title="Actualizar"><span class="glyphicon glyphicon-edit">&nbsp;</span>
                    </a>
...
<script type="text/javascript" src="../crud/crudCargo.js"></script>
