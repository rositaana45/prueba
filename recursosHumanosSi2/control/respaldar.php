...
or die("No se puede conectar con el servidor MySQL");
...
$info['mysqlver'] = mysqli_get_server_info($conexion); //mysql_get_server_info(); 
...
if ( !headers_sent() ) {
    ...
    case "bz2": 
        ...
        break;
		case "gzip": 
        header("Content-Disposition: attachment; filename=$nombre.gzip");
