		        ...
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu multi-column columns-2">
			            <div class="row">
				           ...
				           <!-- <div class="col-sm-4">
					            <ul class="multi-column-dropdown">
						            <li><a href="../profesion/profesion.php"><span class="glyphicon glyphicon-file">&ensp;</span>Profesión</a></li>
                                    <li class="divider"></li>
						            <li><a href="../seguro/seguro.php"><span class="glyphicon glyphicon-plus">&ensp;</span>Seguro</a></li>
						            <li><a href="../tipo_seguro/tipo_seguro.php"><span class="glyphicon glyphicon-plus-sign">&ensp;</span>Tipo Seguro</a></li>
						            <li class="divider"></li>
						            <li><a href="../horario/horario.php"><span class="glyphicon glyphicon-time">&ensp;</span>Horario</a></li>
					            </ul>
				            </div>-->
			            </div>
		            </ul>
